#!/usr/bin/env python3
"""TSM compact operations runner v7.9.
...
def validate_operations(bundle: dict) -> tuple[dict, dict]:
    ...
    if book_reference.get("conflict_policy") != "disclose_difference_current_corpus_prevails_for_current_basis":
...
def public_book_reference_audit(root: Path, bundle: dict) -> dict:
    ...
    checks = {
        ...
        "conflict_policy": config.get("conflict_policy") == "disclose_difference_current_corpus_prevails_for_current_basis",
